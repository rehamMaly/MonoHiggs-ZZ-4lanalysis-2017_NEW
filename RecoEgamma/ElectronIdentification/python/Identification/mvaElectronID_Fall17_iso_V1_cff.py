...
mvaFall17WeightFiles_V1 = cms.vstring(
    "RecoEgamma/ElectronIdentification/data/Fall17/electronID_mva_Fall17_iso_V1_EB1_5.weights.xml.gz",
    "RecoEgamma/ElectronIdentification/data/Fall17/electronID_mva_Fall17_iso_V1_EB2_5.weights.xml.gz",
    "RecoEgamma/ElectronIdentification/data/Fall17/electronID_mva_Fall17_iso_V1_EE_5.weights.xml.gz",
    "RecoEgamma/ElectronIdentification/data/Fall17/electronID_mva_Fall17_iso_V1_EB1_10.weights.xml.gz",
    "RecoEgamma/ElectronIdentification/data/Fall17/electronID_mva_Fall17_iso_V1_EB2_10.weights.xml.gz",
    "RecoEgamma/ElectronIdentification/data/Fall17/electronID_mva_Fall17_iso_V1_EE_10.weights.xml.gz"
    )
...
MVA_WPHZZ = EleMVA_WP(
    ...
    mvaValueMapName = mvaValueMapName,           # map with MVA values for all particles
    mvaCategoriesMapName = mvaCategoriesMapName, # map with category index for all particles
    cutCategory0 =  0.6282314508618512, # EB1 low pt
    cutCategory1 =  0.5922759800216235, # EB2 low pt
    cutCategory2 =  0.636928856343224, # EE low pt
    cutCategory3 =   0.03554496382023676, # EB1
    cutCategory4 =   0.04342450751424789, # EB2
    cutCategory5 =  -0.2660000237162611   # EE
    )
...
mvaEleID_Fall17_V1_wpHZZ = configureVIDMVAEleID_V1( MVA_WPHZZ )
