   ...
   */
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	if(iparton < LHE_PARTON_N){
      ...
      //Reham 1:2254:184363
      if (!(Run==1 && LumiSection==2468 && Event==219587)) continue;
	...
	int tag;
	  ...
	  cout<<"Muons isolation = "<<RECOMU_PFX_dB_new[iL[i]]<<" , "<<RECOMU_PFX_dB_new[iL[j]]<<endl;
	...
	cout<<"Zcandvector mass = "<<Zcandvector.at(index).massvalue<<endl;
	...
	if(  MC_type == "Fall17"  && DATA_type == "NO"){ 
	  ...
	  Double_t SC_Eta = RECOELE_scl_Eta[ z2lept[i] ]; //Reham
...
//       }
     ...
     if (Z1tag==1 && Z2tag==2){// ZmumuZee

   output_txt << "EVENT_7:"<< Run<< ":" << LumiSection<< ":" << Event << ":" << mass4l<< ":" << massZ1<< ":" << massZ2 << ":" << f_D_bkg_kin<< ":" << RECOMU_PT[ ipt[0] ] << ":" << RECOMU_PT[ ipt[1] ] << ":" << RECOELE_PT[ ipt[2] ] << ":" << RECOELE_PT[ ipt[3] ] << ":" << RECOMU_ETA[ ipt[0] ] << ":" <<RECOMU_ETA[ ipt[1] ]<< ":" <<RECOELE_ETA[ ipt[2] ]<< ":" <<RECOELE_ETA[ ipt[3] ]<< ":" << RECOMU_PHI[ ipt[0] ] << ":" << RECOMU_PHI[ ipt[1] ] << ":" << RECOELE_PHI[ ipt[2] ] << ":" << RECOELE_PHI[ ipt[3] ]<<endl;
     
} 
     else if (Z1tag==2 && Z2tag==1){// ZeeZmumu

     output_txt << "EVENT_7:"<< Run<< ":" << LumiSection<< ":" << Event << ":" << mass4l<< ":" << massZ1<< ":" << massZ2 << ":" << f_D_bkg_kin<< ":" <<RECOELE_PT[ ipt[0] ]<< ":" <<RECOELE_PT[ ipt[1] ]<< ":" <<RECOMU_PT[ ipt[2] ]<<":"<<RECOMU_PT[ ipt[3] ]<< ":" <<RECOELE_ETA[ ipt[0] ]<< ":" <<RECOELE_ETA[ ipt[1] ]<< ":" <<RECOMU_ETA[ ipt[2] ]<< ":" <<RECOMU_ETA[ ipt[3] ]<< ":" << RECOELE_PHI[ ipt[0] ]<< ":" <<RECOELE_PHI[ ipt[1] ]<< ":" <<RECOMU_PHI[ ipt[2] ]<<":" <<RECOMU_PHI[ ipt[3] ]<<endl;
      }
